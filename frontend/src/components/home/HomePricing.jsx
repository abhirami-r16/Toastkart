...
export default function HomePricing() {
  ...
  return (
    <section id="pricing" className="pricing-page-wrapper" style={{ minHeight: 'auto', paddingTop: '2rem' }}>
      {/* Header Section */}
      ...
      <div className="pricing-cards-container">
        ...
        <div className="pricing-card">
          ...
          <button onClick={() => navigate('/login')} className="btn-get-started btn-outline">Get Started</button>
        </div>
        ...
        <div className="pricing-card popular">
          ...
          <button onClick={() => navigate('/login')} className="btn-get-started btn-solid">Get Started</button>
        </div>
      ...
      {/* Footer Features */}
      <div className="pricing-footer" style={{ borderTop: 'none', paddingBottom: '0' }}>
        <div className="trust-badges mx-auto justify-content-center border-top pt-4 w-100" style={{ maxWidth: '1200px' }}>
          ...
          <div className="footer-logo ms-lg-auto d-flex flex-column align-items-end">
